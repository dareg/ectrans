...
write (0,*) __FILE__, __LINE__; call flush(0)
  ...
  !$ACC DATA IF(PRESENT(PGPUV)) COPYIN(PGPUV,IUVLEVS,IUVPARS)
  !$ACC DATA IF(PRESENT(PGP2)) COPYIN(PGP2,IGP2PARS)
  !$ACC DATA IF(PRESENT(PGP3A)) COPYIN(PGP3A,IGP3ALEVS,IGP3APARS)
  !$ACC DATA IF(PRESENT(PGP3B)) COPYIN(PGP3B,IGP3BLEVS,IGP3BPARS)
